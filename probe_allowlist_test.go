...
var recordedCapabilityProbes = map[string]probeAllowEntry{
	...
	"infrastructure/sqlite/prepared_migration_catalog.go:360":    {class: "false-positive", site: "catalog", verdict: "kept", reason: "local variable tableExists, not a probe helper"},
	"infrastructure/sqlite/prepared_migration_catalog.go:361":    {class: "integrity", site: "bootstrap", verdict: "kept", reason: "schema_migrations presence is the catalog bootstrap invariant"},
	"infrastructure/sqlite/prepared_migration_catalog.go:364":    {class: "false-positive", site: "catalog", verdict: "kept", reason: "local variable tableExists, not a probe helper"},
