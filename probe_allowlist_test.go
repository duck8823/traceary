...
var recordedCapabilityProbes = map[string]probeAllowEntry{
	...
	"infrastructure/sqlite/compaction_files.go:560":              {class: "platform", site: "offline exchange", verdict: "kept", reason: "atomic file exchange is a platform capability, not schema compatibility"},
	...
	"infrastructure/sqlite/restore_dedupe_archive.go:121":        {class: "integrity", site: "sibling-offline 081", verdict: "kept", reason: "hasCodec parameter of 081 restore"},
	"infrastructure/sqlite/restore_dedupe_archive.go:124":        {class: "integrity", site: "sibling-offline 081", verdict: "kept", reason: "hasCodec branch of 081 restore"},
	"infrastructure/sqlite/restore_dedupe_archive.go:141":        {class: "integrity", site: "sibling-offline 081", verdict: "kept", reason: "hasCodec branch of 081 restore"},
	"infrastructure/sqlite/restore_dedupe_archive.go:166":        {class: "integrity", site: "sibling-offline 081", verdict: "kept", reason: "hasCodec parameter of 081 restore"},
	"infrastructure/sqlite/restore_dedupe_archive.go:169":        {class: "integrity", site: "sibling-offline 081", verdict: "kept", reason: "hasCodec branch of 081 restore"},
	"infrastructure/sqlite/restore_dedupe_archive.go:24":         {class: "integrity", site: "sibling-offline 081", verdict: "carved-out", reason: "081 restore inspects the archive table before 082"},
	"infrastructure/sqlite/restore_dedupe_archive.go:52":         {class: "integrity", site: "sibling-offline 081", verdict: "kept", reason: "081 executes before 082 so body_codec is still present at restore"},
	"infrastructure/sqlite/restore_dedupe_archive.go:56":         {class: "integrity", site: "sibling-offline 081", verdict: "kept", reason: "hasCodec parameter of 081 restore"},
	"infrastructure/sqlite/restore_dedupe_archive.go:81":         {class: "integrity", site: "sibling-offline 081", verdict: "kept", reason: "hasCodec parameter of 081 restore"},
