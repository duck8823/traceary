...
Two things v0.34 was meant to promise, it does not. Both were measured during the release gate ([#1620](https://github.com/duck8823/traceary/issues/1620)) and the claim was withdrawn rather than the measurement adjusted. A claim quietly dropped reads as a claim still made, so they are stated here.
