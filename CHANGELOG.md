...
- **14-day auto-expire for stale candidates (#834)** — gc deletes `extracted-hidden` candidates older than 14 days, NULL-ing any incoming `supersedes_memory_id` references first to keep FK constraints intact.
