...
Two things v0.34 was meant to promise, it does not, and one thing it builds is read by nothing. The first two were measured during the release gate ([#1620](https://github.com/duck8823/traceary/issues/1620)) and the claim was withdrawn rather than the measurement adjusted; the third was found while cutting the release. A claim quietly dropped reads as a claim still made, so all three are stated here.
