...
- **Dedicated Top tab and editable Settings (#1055, #1056)** — the cockpit separates Tail and Top into distinct tabs, and Settings now supports arrow-key form controls for safe language/read/redaction configuration updates without leaving the TUI.
...
### Notes
- v0.19.0 has no SQLite schema migration and no new MCP tools.
