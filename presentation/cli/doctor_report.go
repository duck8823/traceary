...
func doctorSectionNameForCheck(name string) string {
	switch {
	case name == "db-path" || name == "db-write" || name == "stale-active-sessions" || name == "archive-retention" || strings.HasSuffix(name, "-capacity-retention") || name == "audit-reliability" || name == "content-event-reliability" || name == "sensitive-access-audit" || name == "retry-loops":
		return "Database"
