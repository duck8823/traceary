...
func doctorSectionNameForCheck(name string) string {
	switch {
	case name == "db-path" || name == "db-write" || name == "store-capacity" || name == "stale-active-sessions" || name == "offline-migrations" || name == "unavailable-retention" || name == "one-off-repairs" || name == "workspace-aliases" || name == "audit-reliability" || name == "content-event-reliability" || name == "sensitive-access-audit" || name == "retry-loops":
		return "Database"
