...
func (tailStoreManagementStub) CollectGarbage(context.Context, time.Time, time.Time, apptypes.GarbageCollectionTarget, bool) (apptypes.CollectGarbageResult, error) {
