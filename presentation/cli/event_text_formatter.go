...
// a CJK locale; that drift would make compact-row and timeline
// widths environment-dependent. We choose narrow because Traceary's
// output ships in markdown / monospace contexts where most fonts
// render ambiguous characters as 1 column.
func init() {
