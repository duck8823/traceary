...
var preparedMigrationManifest = map[int64]migrationManifestEntry{
	...
	// 48 rewrites every command_executed events.body to empty; cost scales
	// with historical audit volume → data_dependent_offline (like 000045).
	48: {48, "000048_clear_command_executed_event_bodies.sql", "9e5a5827f3dc57030e59c04289395a05c84a87f9b5ab9139fb49eddf9c3563b1", MigrationDataDependentOffline},
}
