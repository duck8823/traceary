...
v0.34 が約束するはずだったもののうち、2 つは約束できていません。いずれもリリースゲート（[#1620](https://github.com/duck8823/traceary/issues/1620)）で実測し、測定値のほうを調整するのではなく主張を取り下げました。黙って落とした主張は、まだ主張しているのと同じに読まれます。したがってここに明記します。
