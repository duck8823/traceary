...
v0.34 が約束するはずだったもののうち 2 つは約束できておらず、さらに構築しているものの 1 つはどこからも読まれていません。前者 2 つはリリースゲート（[#1620](https://github.com/duck8823/traceary/issues/1620)）で実測し、測定値のほうを調整するのではなく主張を取り下げました。3 つ目はリリースを切る作業中に判明したものです。黙って落とした主張は、まだ主張しているのと同じに読まれます。したがって 3 件ともここに明記します。
