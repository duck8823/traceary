...
func (s *storeInitializerStub) CollectGarbage(_ context.Context, _ time.Time, _ time.Time, _ apptypes.GarbageCollectionTarget, _ bool) (int, error) {
	return 0, nil
}
...
func (s *storeInitializerStub) ListContentEventDedupeRuns(_ context.Context) ([]apptypes.ContentEventDedupeRun, error) {
	return nil, nil
}
