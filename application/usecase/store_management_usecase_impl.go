...
func (u *storeManagementUsecase) CollectGarbage(
	...
	if foldedBefore.IsZero() {
		return apptypes.CollectGarbageResult{}, xerrors.Errorf("foldedBefore timestamp is required")
	}
	...
	deletedCount, err := u.storeManager.CollectGarbage(ctx, before, foldedBefore, target, dryRun)
	if err != nil {
