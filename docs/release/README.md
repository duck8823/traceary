...
5. opens or updates a dedicated Homebrew formula PR (`maintenance/homebrew-vX.Y.Z`) with a GitHub App installation token instead of direct-pushing to protected `main`
