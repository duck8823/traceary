...
- `integrations/claude-plugin/.claude-plugin/plugin.json`、`integrations/antigravity-plugin/plugin.json`、`integrations/gemini-extension/gemini-extension.json`、`integrations/grok-plugin/plugin.json`、`plugins/traceary/.codex-plugin/plugin.json` の `version` が root の `VERSION` と一致すること
