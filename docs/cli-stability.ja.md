...
- `traceary integration codex install` → Codex 公式の `/plugins` flow (v0.14.0 で廃止)
- `traceary integration codex uninstall` → Codex 公式の `/plugins` flow と `docs/integrations/codex-plugin.md` の手動 cleanup 手順 (v0.15.0 で廃止)
