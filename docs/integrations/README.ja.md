...
- Codex: plugin manifest の構造検証（`hooks: "./hooks.json"` / commands / skills）と、隠しコマンド `traceary integration codex uninstall` の cleanup-only path の smoke（v0.15 までは旧 install を片付けられるよう残す）
