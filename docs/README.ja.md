...
- [インタラクティブ運用ガイド](./interactive/README.ja.md): `list`、`list --follow`、`search`、`show`、`context --handoff` の使い分け
...
- [Cockpit UI/UX design baseline（履歴）](./operations/cockpit-ui-ux-design.ja.md): 旧 v0.18 再設計メモ。cockpit は v0.35.0 で削除
