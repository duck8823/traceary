...
7. Merge the **Homebrew formula PR** generated by goreleaser (auto-created on `maintenance/homebrew-vX.Y.Z` branch)
...
**Do not skip step 7.** The Homebrew formula PR is auto-generated but requires manual merge.
